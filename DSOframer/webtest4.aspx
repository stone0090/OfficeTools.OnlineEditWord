<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="webtest4.aspx.cs" Inherits="DSOframer.webtest4" %>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="120px" style="vertical-align: top;">
                        ...
                        <input type="button" value="上传word到服务器" onclick="UploadWord('<%= Request.Url.Authority %>')" style="color: red;" />
